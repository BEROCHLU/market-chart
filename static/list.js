export const arrTicker = [
    ...
    'TWTR', 'SQ', 'AMD', 'NVDA', 'BTC-USD', 'SPXL', 'UPRO', 'UDOW', 'TECL', 'TQQQ', 'TNA', 'SPXS', 'SPXU', 'SDOW', 'TECS', 'SQQQ', 'TZA', 'FAZ', 'VXX', 'UVXY', 'TVIX',
    'GLD', 'USO', 'TLT', 'BA', 'UNH', 'MMM', 'HD', 'MCD', 'V', 'JNJ', 'GE', 'BRK-B', 'CVX', 'PG', 'WMT', 'XOM', 'FSLY', 'NET', 'DDOG', 'DT', 'ROKU', 'NIO',
    'MRNA', 'CODX', 'VIR', 'INO', 'SRNE', 'MDB', 'WORK', 'OKTA', 'SHOP', 'CURE', 'XLK', 'FXI',
    '^FTSE', 'JPY=X', 'GBPJPY=X'
];
