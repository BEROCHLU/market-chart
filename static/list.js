export const arrTicker = [
    ...
    'MDB', 'OKTA', 'SHOP', 'CURE', 'XLK', 'FXI', 'MRNA', 'CODX', 'VIR', 'INO', 'SRNE',  'BNTX', 'VXRT', 'NVAX', 'BCRX', 'CHGG',
    '^FTSE', '^FCHI', '^GDAXI', '^RUT', 'JPY=X', 'GBPJPY=X', 'CRSR', 'PLTR', 'CVAC', 'SUMO', 'WEBL', 'WEBS', 'U', 'AI', 'ABNB', 'DASH'
];
